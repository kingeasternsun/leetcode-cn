...
impl Solution {
    ...
    // 代码简化
    pub fn min_operations1(s: String) -> i32 {
        let exp = "01".as_bytes();
        let bytes = s.as_bytes();
        let mut ret0 = 0;
        let mut ret1 = 0;
...
mod tests {
    ...
    #[test]
    fn it_works1() {
        assert_eq!(Solution::min_operations1(String::from("0100")), 1);
        assert_eq!(Solution::min_operations1(String::from("1000")), 1);
        assert_eq!(Solution::min_operations1(String::from("10")), 0);
        assert_eq!(Solution::min_operations1(String::from("01")), 0);
        assert_eq!(Solution::min_operations1(String::from("101")), 0);
        assert_eq!(Solution::min_operations1(String::from("010")), 0);
        assert_eq!(Solution::min_operations1(String::from("1111")), 2);
        assert_eq!(Solution::min_operations1(String::from("0")), 0);
        assert_eq!(Solution::min_operations1(String::from("1")), 0);
    }
}
