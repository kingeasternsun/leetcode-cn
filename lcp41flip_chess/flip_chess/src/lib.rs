...
impl Solution {
    fn can_flip(chessboard: &Vec<Vec<char>>, cur: (i32, i32), dir: &(i32, i32)) -> (i32, bool) {
        ...
        for i in 0..board_size.0 {
            for j in 0..board_size.1 {
                ...
                while queue.len() >0 {
                    let cur = queue.pop();
                    for dir in &dirs{
                        let ret = Self::can_flip(&chessboard, (cur.0 as i32, cur.1 as i32), dir);
                        if !ret.1{
                            continue;
                        }
...
mod tests {
    ...
    #[test]
    fn it_works() {
        assert_eq!(Solution::flip_chess(vec![
            String::from("....X."),
            String::from("....X."),
            String::from("XOOO.."),
            String::from("......"),
